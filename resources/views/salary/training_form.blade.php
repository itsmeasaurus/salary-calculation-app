    ...
    <div>
        ...
        <div class="relative mt-2 rounded-md">
            <input
                ...
                value="{{ Salary::getTrainingSalary() }}"
                disabled>
            <input type="hidden" name="basic_salary" value="{{ Salary::getTrainingSalary() }}">
        </div>
    </div>
    <div>
        <label for="working_days" class="block text-sm font-medium leading-6 text-gray-900">Working Days</label>
        <div class="relative mt-2 rounded-md">
